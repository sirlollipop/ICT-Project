...
function valiPalaute3()
{
    ...
    if (number <=40) {
            ...
            palaute = 'I need to focus on gaining more knowledge of career guidance methods and techniques. I acquire the skills to identify a student’s strengths. I take care of developing my students ’job search skills. I develop my competence assessment skills.  '
        }
        document.getElementById('valiPalaute').innerHTML =
        palaute;
};
